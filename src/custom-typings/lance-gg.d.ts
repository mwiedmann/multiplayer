...
export class AFrameRenderer<GE extends GameEngine<PhysicsEngine>, CE extends ClientEngine<GE>> extends Renderer<
  GE,
  CE
> {
  draw(): void
...
export class ServerEngine<PE extends PhysicsEngine = PhysicsEngine> {
  ...
  constructor(io: any, gameEngine: GameEngine<PE>, options?: ServerEngineOptions)
